                ...
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <div class="profile_ifo_area">
                            <form action="${pageContext.request.contextPath }/front/user/updateProfile.action" method="post">
                                <div class="form_group">
                                    <span class="dd">昵&#x3000;称：</span><input type="text" name="nickName" value="${user.nickName}" >
                                </div>
                                <div class="form_group">
                                    <span class="dd">性&#x3000;别：</span>
                                    <input type="radio" id="man" <c:if test="${user.sex==0}">checked='checked'</c:if> value="0" name="sex"><label for="man">男</label>
                                    <input type="radio" id="woman" <c:if test="${user.sex==1}">checked='checked'</c:if> value="1" name="sex"><label for="woman">女</label>
                                </div>
                                <div class="form_group">
