			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="vidioTitle"
						placeholder="视频标题" name="videoTitle">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="vidioTime"
						placeholder="视频时长(秒)" name="videoLength">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="picture"
						placeholder="视频封面图片地址,网络图片" name="videoImageUrl">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="vidioAddress"
						placeholder="视频播放地址,网络地址" name="videoUrl">
				</div>
			</div>
			<div class="form-group">
				<label for="vidioAbout" class="col-sm-2 control-label">视频简介</label>
				<div class="col-sm-10">
					<textarea class="form-control" id="vidioAbout" name="videoDescr"></textarea>
				</div>
			</div>
