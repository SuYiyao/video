	...
	<div class="container theme-showcase" role="main">
		...
		<form class="form-horizontal" action="${pageContext.request.contextPath }/course/editCourse.action" method="post">
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<c:forEach var="co" items="${list}" varStatus="status" >
						<option value="${co.id }" ${co.id==course.subjectId?"selected":"" }>${ co.subjectName }</option>
					</c:forEach>	
					</select>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="position" name="courseName" value="${course.courseName }"
						placeholder="课程标题">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea class="form-control" id="about" name="courseDescr">${course.courseDescr }</textarea>
				</div>
			</div>

			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<input type="hidden" name="id" value="${course.ids }">
